...
function setup() {
  ...
  ground = createSprite(900,200,1200,20);
  ...
  invisibleGround = createSprite(500,200,1200,10);
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(1300,200,40,10);
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(1300,185,10,40);
    //obstacle.debug = true;
